...
public:
    ...
    void TuningFrequency( const string& filename, int framesize
                        , int hopsize, int zeropadding
    ...
    void TonalDescriptors( const string& filename, int framesize
                         , int hopsize, int zeropadding, Real rgain
                         , Real tuningFrequency, Pool& pool)
    {
        streaming::AlgorithmFactory& factory = streaming::AlgorithmFactory::instance();
    ...
    std::string CalculateKey(const std::string& file)
    {
        ...
        return pool.value<string>("tonal.key") + " " + pool.value<string>("tonal.key_scale");
